<%@ Page Title="" Language="C#" MasterPageFile="~/ProgramSorumlusu.Master" AutoEventWireup="true" CodeBehind="DuyuruGüncelle.aspx.cs" Inherits="ÖğrenciİşleriOtomasyonu.DuyuruGüncelle" %>
    ...
    <div class="card-body">
        <form runat="server">
            <div class="row">
                ...
                <br />
                <div>
                    <asp:Button ID="Güncelle" Text="Güncelle" CssClass="btn btn-dark" runat="server" OnClick="Güncelle_Click" />
                </div>
            </div>
        </form>
    </div>
