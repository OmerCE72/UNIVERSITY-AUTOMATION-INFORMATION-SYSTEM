<%@ Page Title="" Language="C#" MasterPageFile="~/Öğrenci.Master" AutoEventWireup="true" CodeBehind="ÖğrenciProfil.aspx.cs" Inherits="ÖğrenciİşleriOtomasyonu.ÖğrenciProfil" %>
    ...
    <div class="card-body">
        <form runat="server">
            <div class="row">
                ...
                <div class="mb-3 col-md-6">
                    <label for="organization" class="form-label">Devamsızlık</label>
                    <asp:TextBox class="form-control" type="text" ID="Devamszilik" ReadOnly="true" runat="server" required />
                </div>
                <div class="mb-3 col-md-6">
