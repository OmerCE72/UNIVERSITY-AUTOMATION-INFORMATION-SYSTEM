<%@ Page Title="" Language="C#" MasterPageFile="~/ProgramSorumlusu.Master" AutoEventWireup="true" CodeBehind="AkademisyenEkle.aspx.cs" Inherits="ÖğrenciİşleriOtomasyonu.AkademisyenEkle" %>
    ...
    <div class="card-body">
        <form runat="server">
            <div class="row">
                ...
                <div class="mb-3 col-md-6">
                    <br />
                    <asp:Button ID="Ekle" Width="100%" Text="Ekle" CssClass="btn btn-info" runat="server" OnClick="Ekle_Click" />
                </div>
            </div>
        </form>
    </div>
