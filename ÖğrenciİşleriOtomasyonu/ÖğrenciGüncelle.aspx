<%@ Page Title="" Language="C#" MasterPageFile="~/ProgramSorumlusu.Master" AutoEventWireup="true" CodeBehind="ÖğrenciGüncelle.aspx.cs" Inherits="ÖğrenciİşleriOtomasyonu.ÖğrenciGüncelle" %>
    ...
    <div class="card-body">
        <form runat="server">
            <div class="row">
                ...
                <asp:Button ID="Güncelle" Width="100%" Text="Güncelle" CssClass="btn btn-info" runat="server" OnClick="Güncelle_Click" />
            </div>
    </form>
    </div>
</asp:Content>
